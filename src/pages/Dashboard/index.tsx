  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const formattedBalance = {
        income: formatValue(parseInt(responseBalance.income)),
        outcome: formatValue(parseInt(responseBalance.outcome)),
        total: formatValue(parseInt(responseBalance.total)),
      };
